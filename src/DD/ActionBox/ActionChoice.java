 ...
 * what feats/abilities will be added as components. We will draw these from the Character class.
 * 
...
public class ActionChoice extends RenderComponent
{
	...
	{ /* Logic that should take place when action is clicked on */
		RenderComponent subActions[] = Character.getSubActions(this.id);
		
		/* Need to add the subActions to ActionBox's subActions */
