...
import slick.path2glory.blockgame.Piece.Tuple;
...
public class GameplayState extends BasicGameState{
    ...
    public void init(GameContainer gc, StateBasedGame sb) throws SlickException {
        ...
        Image allImages = new Image("Images/BlockGame/gameplaytextures.png");
 
        gameHUD = new Image("Images/BlockGame/hudblockgame.jpg");
